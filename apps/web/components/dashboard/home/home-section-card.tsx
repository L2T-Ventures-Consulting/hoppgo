...
/**
 * Card shell shared by every section of the home page (activity, pending
 * requests, quick actions, storefront). Same paddings, same header rhythm,
 * same accent tile — widgets only provide their content.
 */
export const HomeSectionCard = ({
  ...
  <Card className={cn("flex min-w-0 flex-col", className)}>
    <CardHeader className="flex flex-row items-center gap-3 p-4 pb-3 sm:p-5 sm:pb-3">
      {icon && <HomeIconTile icon={icon} accent={accent} />}
